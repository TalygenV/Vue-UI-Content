...
(function (root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        ...
        root.talygen = factory(root.jQuery);
    }
          ...
          "<div class=' modal' tabindex='-1' role='dialog'>" +
            "<div class='modal-dialog'>" +
              "<div class='modal-content'>" +
                "<div class='modal-body p-0 notifybox'><div class='-body text-center  my-2 py-0'></div></div>" +
              "</div>" +
            "</div>" +
          "</div>",
        header:
          "<div class='modal-header custombox-header'>" +
            "<h4 class='modal-title'></h4>" +
          "</div>",
        footer:
          "<div class='modal-footer my-0 py-2'></div>",
        closeButton:
          "<button type='button' class='-close-button close d-none' data-dismiss='modal' aria-hidden='true'>&times;</button>",
        form:
     ...
     */
    function _t(key) {
        var name = cur == null ? defaults.locale : cur.name;
     ...
     * range of inputs and return valid options suitable for passing to .dialog
     */
    ...
    exports.dialog = function (options) {
        ...
        each(buttons, function (key, button) {
            ...
            buttonStr += "<button data-bb-handler='" + key + "' type='button' title=" + button.label + " class='btn " + button.className + "'><i class='fa " + fontClass + "'></i> " + button.label + "</button>";
        ...
        dialog.on("show.bs.modal", function() {
          ...
          if (options.backdrop) {
            dialog.next(".modal-backdrop").addClass("-backdrop");
          }
        });
        */
        ...
        /**
         *  event listeners; experimental and may not last

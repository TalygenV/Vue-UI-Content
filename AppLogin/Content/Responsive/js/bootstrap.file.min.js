! function (t) {
    ...
    e.prototype = {
        ...
        buttonTitle: function (t) {
            return void 0 === t ? this.options.buttonTitle : (this.options.buttonTitle = t, void this.$elementFilestyle.find("label span").title(this.options.buttonTitle))
        },
        ...
        iconName: function (t) {
            return void 0 === t ? this.options.iconName : void this.$elementFilestyle.find(".glyphicon").attr({
        ...
        htmlInput: function () {
            var stylewidth = "";
            if (this.options.width > 30) {
                return this.options.input ? '<input type="text" style="width:' + this.options.width + '% !important" class="form-control ' + ("nr" == this.options.size ? "" : "input-" + this.options.size) + '" disabled> ' : ""
            }
            return this.options.input ? '<input type="text" class="form-control disabled' + ("nr" == this.options.size ? "" : "input-" + this.options.size) + '" disabled> ' : ""
        },
        ...
        constructor: function () {
            var e = this,
                ...
                n = e.$element.attr("id"),
                s = "";
            "" !== n && n || (n = "filestyle-" + t(".bootstrap-filestyle").length, e.$element.attr({
                id: n
            })), s = '<div class="input-group-append" style="cursor:pointer;"><span class="group-span-filestyle ' + (e.options.input ? "input-group-btn" : "") + ' input-group-text bg-white"><label title="' + e.options.buttonTitle + '" for="' + n + '" class="' + e.options.buttonName + " " + ("nr" == e.options.size ? "" : "btn-" + e.options.size) + '" ' + (e.options.disabled ? 'disabled="true"' : "") + ">" + e.htmlIcon() + e.options.buttonText + "</label></span></span>", i = e.options.buttonBefore ? s + e.htmlInput() : e.htmlInput() + s, e.$elementFilestyle = t('<div class="bootstrap-filestyle input-group">' + i + "</div>"), e.$elementFilestyle.find(".group-span-filestyle").attr("tabindex", "0").keypress(function (t) {
    ...
    t.fn.filestyle = function (i, n) {
        ...
        buttonTitle: "Click here to select a file",
        iconName: "glyphicon-folder-open",
        buttonName: "mb-0 font-weight-normal",
        size: "nr",
        input: !0,
        badge: !0,
        icon: !0,

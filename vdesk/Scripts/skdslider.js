; (function ($) {
    ...
    function Skdslider(container, options) {
        ...
        if (this.options.showRandom) {
            var randomSlide = Math.floor(Math.random() * this.totalSlides);
            console.log(randomSlide)
            this.currentSlide = randomSlide;
            if (randomSlide + 1 == this.totalSlides)
                this.nextSlide = 0;
            else
                this.nextSlide = randomSlide + 1;
        }
